            ...
            <div className="spacing max-width flex flex-col">
                <div className="w-full h-6 md:h-8 flex items-center justify-end max-md:hidden">
                    ...
                    <div className="flex items-center gap-1.75">
                        ...
                        <a
                            href="https://www.instagram.com/smriti.ashtangayoga?igsh=MWkzZnJwN2dmMG03&utm_source=qr"
                            target="_blank"
                            rel="noopener noreferrer" className="size-6 md:size-8 flex items-center justify-center rounded-full bg-black/10 cursor-pointer">
                        ...
                        <a
                            href="https://maps.app.goo.gl/FAFngwTYh8iCHMkt5?g_st=ic"
                            target="_blank"
                            rel="noopener noreferrer" className="size-6 md:size-8 flex items-center justify-center rounded-full bg-black/10 cursor-pointer">
                    ...
                    <div className="py-1 md:py-2 3xl:py-3 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1.75 md:hidden">
                            ...
                            <a
                                href="https://www.instagram.com/smriti.ashtangayoga?igsh=MWkzZnJwN2dmMG03&utm_source=qr"
                                target="_blank"
                                rel="noopener noreferrer" className="size-6 md:size-8 flex items-center justify-center rounded-full bg-[#cfc7bb] cursor-pointer">
